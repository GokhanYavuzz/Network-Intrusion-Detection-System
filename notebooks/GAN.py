...
for epoch in range(EPOCHS):
    ...
    for i, (real_normal_batch,) in enumerate(normal_loader):
        ...
        # B. Adversarial Loss (Surrogate'i kandır: "Ben Normal bir trafiğim" de)
        gen_logits = surrogate_mlp(fake_data)
        
        # Hedef: Surrogate'in "Normal" sınıfı (Indexini bilmen lazım, genelde 0 veya 1'dir)
        # LabelEncoder'da "Normal" kaçıncı sıradaysa o indexi kullanmalısın.
        # Örnek: Eğer le.classes_ çıktısında 'Normal' 1. indexteyse:
